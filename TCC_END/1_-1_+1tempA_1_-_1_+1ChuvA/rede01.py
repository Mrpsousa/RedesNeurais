...
# The Input Layer :
NN_model.add(Dense(8, kernel_initializer='normal',input_dim = train.shape[1], activation='relu'))
...
wights_file = 'Weights-1195--1033.46774.hdf5' # choose the best checkpoint 
