...
# The Input Layer :
NN_model.add(Dense(7, kernel_initializer='normal',input_dim = train.shape[1], activation='relu'))
...
wights_file = 'Weights-1436--689.64492.hdf5' # choose the best checkpoint 
