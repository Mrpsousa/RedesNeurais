...
# The Input Layer :
NN_model.add(Dense(13, kernel_initializer='normal',input_dim = train.shape[1], activation='relu'))
...
wights_file = 'Weights-1002--1094.44787.hdf5' # choose the best checkpoint 
