...
# The Hidden Layers :
NN_model.add(Dense(22, kernel_initializer='normal',activation='relu'))
NN_model.add(Dense(22, kernel_initializer='normal',activation='relu'))
NN_model.add(Dense(22, kernel_initializer='normal',activation='relu'))
...
#Train the model
NN_model.fit(train, target, epochs=3000, batch_size=3, validation_split = 0.2, callbacks=callbacks_list)

# Load wights file of the best model :
wights_file = 'Weights-2810--792.61132.hdf5' # choose the best checkpoint 
