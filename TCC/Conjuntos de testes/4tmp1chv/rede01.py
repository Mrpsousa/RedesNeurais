...
# The Input Layer :
NN_model.add(Dense(9, kernel_initializer='normal',input_dim = train.shape[1], activation='relu'))
...
#Train the model
NN_model.fit(train, target, epochs=1600, batch_size=3, validation_split = 0.2, callbacks=callbacks_list)

# Load wights file of the best model :
wights_file = 'Weights-1158--650.94582.hdf5' # choose the best checkpoint 
